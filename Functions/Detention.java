public class Detention {
    ...
    public static void main(String[] args) {
                            ...
                            // Create an instance of the Detention class
                Detention detention = new Detention();
                
                // Call the printLines function six times
                for (int i = 0; i < 6; i++) {
                    detention.printLines();
                    System.out.println(); // Add a blank line between each set of lines
                }
            }
